	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		 ...
		 Class.forName("org.mariadb.jdbc.Driver").newInstance();
		  ...
		  String consulta = "SELECT titulo,nombre,imagen from obra,autor WHERE obra.id_autor=autor.id";
		  ...
		  Obra obra=new Obra(rset.getString("titulo"), consulta, consulta, consulta, consulta, consulta, consulta, consulta);
		  ...
		  while (rset.next()) {
		    ...
		    out.println("<td>" + rset.getString("titulo") + "</td><td> " + rset.getString("autor") + "</td><td><img src='./img/"+rset.getString("imagen")+"' width=100 heigh=100></td></tr>");
		  }
		  out.println("</table>");
